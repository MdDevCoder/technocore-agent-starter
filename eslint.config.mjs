...
export default [
  ...
  },
  {
    ...
    files: ["src/ui/**", "src/hooks/**", "src/civilization-ui/**", "src/sonnet-ui/**", "src/observatory-ui/**", "src/doctor-ui/**", "src/testkit-ui/**", "src/forge-ui/**", "src/starter-ui/**", "src/trace-ui/**", "src/workspace-ui/**", "src/health-ui/**", "src/readiness-ui/**", "src/evidence-ui/**", "src/activity-ui/**", "app/**", "middleware.ts", "next.config.ts"],

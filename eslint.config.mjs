...
export default [
  ...
  },
  {
    ...
    files: ["src/ui/**", "src/hooks/**", "src/civilization-ui/**", "src/sonnet-ui/**", "src/observatory-ui/**", "src/doctor-ui/**", "src/testkit-ui/**", "src/forge-ui/**", "src/starter-ui/**", "app/**", "middleware.ts", "next.config.ts"],

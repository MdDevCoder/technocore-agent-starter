    ...
    <main className="min-h-screen bg-void text-ink px-4 py-12 md:px-8 max-w-5xl mx-auto space-y-12">
      ...
      <div className="space-y-4 border-b border-hairline pb-8">
        ...
        <div className="flex flex-wrap gap-4 pt-2">
          ...
          >
            <span>▶ Launch Interactive TestKit Web UI</span>
          </Link>
          <Link
            href="/doctor"
            className="px-5 py-2.5 rounded-lg bg-panel border border-hairline text-ink font-semibold text-sm hover:border-hairline-bright transition-colors mono"
          >
            Signature Doctor →
          </Link>
          <Link

...
const VARIANTS: Record<ButtonVariant, string> = {
  primary: "border-transparent bg-ink text-void hover:bg-white active:bg-ink",
  secondary: "border-hairline bg-panel text-ink hover:border-hairline-bright hover:bg-panel-high",
  ghost: "border-transparent bg-transparent text-muted hover:bg-panel hover:text-ink",
  danger: "border-fault/35 bg-transparent text-fault hover:border-fault/60 hover:bg-fault/10",
};
